          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="col-span-1 md:col-span-2 space-y-8">
              ...
              <div className="bg-gray-200 w-full h-64 rounded-xl flex items-center justify-center text-gray-500 font-bold text-lg shadow-inner">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15948.269316696194!2d86.96764340988972!3d25.235566251710786!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f04a07d6b0d26f%3A0x6a449cbed7cb5a88!2sGyanastu%20Institute%20of%20Accounts%20Technician%20Main%20Branch!5e0!3m2!1sen!2sin!4v1780397905509!5m2!1sen!2sin" width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
              </div>
